...
<div class="row">
    ...
    <div class="col-sm-6"><a href="<?= $url->origin ?>"><?= $url->origin ?></a></div>
</div>

<div class="row">
    <div class="col-sm-3"><strong>Короткий URL : </strong></div>
    <div class="col-sm-6"><a href="<?= Url::to(['site/url-redirect', 'url' => $url->short], true) ?>"><?= Url::to(['site/url-redirect', 'url' => $url->short], true) ?></a></div>
</div>
